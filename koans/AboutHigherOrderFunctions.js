...
describe("About Higher Order Functions", function () {
  ...
  it("should use filter to return array items that meet a criteria", function () {
    ...
    // _(numbers).filter == Underscore.js functionality, _.filter(list, iterator, [context])
    // Looks through each value in the *list, returing an array of all the values that pass *iterator
  ...
  it("should use 'map' to transform each element", function () {
    ...
    // _(numbers).map == Underscore.js functionality, _.map(list, iterator, [context])
    // If *list is a javascript object, *iterators arguments will be: (value, key, list)
    // Produces a new array by running each value in *list through *iterator
  ...
  it("should use 'reduce' to update the same result on each iteration", function () {
    ...
    // _(numbers).reduce == Underscore.js functionality, _.reduce(list, iterator, memo, [context])
    // Boils down *list into a single value; *memo == the initial state of the reduction
